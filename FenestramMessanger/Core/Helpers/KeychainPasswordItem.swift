...
struct KeychainPasswordItem {
    ...
    func readPassword() throws -> String {
        ...
        //parse the password string from query result
        guard let existingItem = queryResult as? [String : AnyObject], let passwordData = existingItem[kSecValueData as String] as? Data, let password = String(bytes: passwordData, encoding: String.Encoding.utf8) else {
    ...
    func savePassword(_ password: String) throws {
        ...
        do {
            //Check for existing item in the keychain
            try _ = readPassword()
